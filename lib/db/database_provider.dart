...
class DatabaseProvider {
  ...
  static const String COLUMN_NUMDER = "numder";
  static const String COLUMN_CS = "cs";
    static const String COLUMN_LOC= "loc";
    static const String COLUMN_MAZUD= "mazud";
    static const String COLUMN_BLG= "blg";
  ...
  Future<List<Food>> getFoods() async {
    ...
    var foods = await db
        .query(TABLE_FOOD, columns: [COLUMN_ID, COLUMN_NAME, COLUMN_CALORIES, COLUMN_NUMDER, COLUMN_CS, COLUMN_LOC, COLUMN_MAZUD, COLUMN_BLG, COLUMN_VEGAN]);
